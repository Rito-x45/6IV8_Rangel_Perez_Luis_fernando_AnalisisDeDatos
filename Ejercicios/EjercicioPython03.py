...
valor_maximo = distancia_eu.values.max()
...
# Encontrar la distancia máxima y los puntos correspondientes (Euclidiana)
valor_maximo = distancia_mh.values.max()
...
# Mostrar tabla de distancias Chebyshev
print("\nTabla de distancias Chebyshev:")
print(distancia_ch)

# Encontrar la distancia máxima y los puntos correspondientes (Euclidiana)
valor_maximo = distancia_ch.values.max()
(punto1, punto2) = distancia_ch.stack().astype(float).idxmax()

print("\nDistancia máxima (Chebyshev):", valor_maximo)
print("Entre los puntos:", punto1, "y", punto2)
